...
//	c0 = getTwosComplement(c0,12)&0xfff;
//	c1 = getTwosComplement(c1,12)&0xfff;
//	c00 = getTwosComplement(c00,20)&0xfffff;
//	c01 = getTwosComplement(c01,20)&0xfffff;
//	c11 = getTwosComplement(c11,16)&0xffff;
//	c20 = getTwosComplement(c20,16)&0xffff;
//	c21 = getTwosComplement(c21,16)&0xffff;
//	c30 = getTwosComplement(c30,16)&0xffff;
...
int32_t DPS310::getTwosComplement(int32_t value, uint8_t length){
